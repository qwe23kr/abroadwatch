...
const incidents: Record<IncidentType, Record<Language, string>> = {
  ...
  "lost-phone": { ko: "휴대폰 분실", "zh-Hans": "手机遗失", ja: "スマホ紛失", "zh-Hant": "手機遺失", en: "Lost phone" },
  "lost-wallet": { ko: "지갑 분실", "zh-Hans": "钱包遗失", ja: "財布紛失", "zh-Hant": "錢包遺失", en: "Lost wallet" },
  hospital: { ko: "병원 이용", "zh-Hans": "就医急诊", ja: "病院・救急", "zh-Hant": "就醫急診", en: "Hospital" },
  "police-report": { ko: "경찰 신고", "zh-Hans": "警方报案", ja: "警察への届出", "zh-Hant": "警方報案", en: "Police report" },
