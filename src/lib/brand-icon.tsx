...
export const siteIcons: Metadata["icons"] = {
  icon: [
    { url: "/icon?v=2", sizes: "96x96", type: "image/png" },
    { url: "/brand-icon/48?v=2", sizes: "48x48", type: "image/png" },
    { url: "/brand-icon/192?v=2", sizes: "192x192", type: "image/png" },
    { url: "/brand-icon/512?v=2", sizes: "512x512", type: "image/png" },
  ],
